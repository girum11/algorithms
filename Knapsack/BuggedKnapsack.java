...
public class BuggedKnapsack {
   ...
   public static List<Item> findBestPack(int totWgt, Item[] items) {
      ...
      for (numItems = items.length; numItems > 0; numItems--) {
         ...
         weight -= items[numItems-1].weight;
      }
